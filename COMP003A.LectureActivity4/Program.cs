/*
 * Author: Joesph Sandoval
 * Course: comp-003A
 * Purpose: Code for lecturing activity 4
 * referecnce: https://learn.microsoft.com/en-us/dotnet/csharp/language-reference/statements/iteration-
 * */
...
namespace COMP003A.LectureActivity4
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //this is a simple array with 10 items in it. you will learn more about arrays in module 7
            string[] simpleArray = new string[] { "eleifend", "donec", "pretium", "vulputate", "sapien", "nex", "sagittis", "aliquam", "malesuada", "bibendum", };
             ...
             * booolean expression evaluates to true. because that expression is evaluated after
             * each execution of the loop, a do loop executes one or more times. the do
             * statement defers from a while loop which executes zero or more times. 
             * */

            int counter2 = 0; // initial counter 2 value 
            ...
            /*
             * the while statement  executes a statement or a block of statements while a specified boolean ecpression evaluates to true. because that expresssion is evaluated before each execution of the loop, while a loop executes zero or more times. the while statement differs from a do loop which executes one or more times.
             * */
            int counter3 = 0; // initial counter3 value;
            while (counter3 < 20)
            {
                Console.WriteLine($"\tCurrent counter 3: {counter3}");
